                            ...
                            <table id="nueva" class="table" >
                                ...
                                <tbody>
                                    ...
                                    for ($x = 0; $x <= count($datos) - 1; $x++) {
                                        ...
                                        $existe_estatus = $this->Pgsql->SELECTPLSQL('estatus', $array);
                                        ...
                                        <tr>
                                            <?php if ($existe_preguntas[0][0] != "") { ?>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($rol == 1 || $rol == 3) { ?>
                                                        <a href="verFormulario?&id_encuesta=<?php echo $id_encuesta ?>">
                                                            <button type='button' class='btn btn-success btn-xs' title="Ver el Formulario">
                                                                <span class='fa fa-search'></span>
                                                            </button>
                                                        </a>
                                                    <?php } ?>
                                                    <?php if ($existe_estatus[0][0] != 0) { ?>
                                                        <a href = "operador?&id_encuesta=<?php echo $id_encuesta ?>">
                                                            <button type = 'button' class = 'btn bg-purple btn-xs' title = "Ver Encuesta">
                                                                <span class = 'fa  fa-phone'></span>
                                                            </button>
                                                        </a>
                                                    
                                                     <a href = "enviar?&id_encuesta=<?php echo $id_encuesta ?>">
                                                            <button type = 'button' class = 'btn bg-purple btn-xs' title = "enviar Encuesta">
                                                                <span class = 'fa  fa-phone'></span>
                                                            </button>
                                                        </a>
                                                    <?php } ?>
