...
<input type="hidden" id="url_respuesta" value="<?php echo base_url() ?>index.php/Formularios/operador?&id_encuesta=<?php echo $datos[0][3] ?>">
...
<section class="content">
    <div class="box box-danger">
        ...
        <div class=" col-sm-12">
            <h3><label>Numero Telef&oacute;nico:<?php echo $datosEncuesta[0][3] ?> </label></h3>
        </div>
        <div class='col-md-12'>

            <button onclick="window.location.reload()" type="button" class="btn btn-info">Siguiente</button> 

            <button type="button" id="desactivar" class="btn btn-warning">Desactivar</button>
        ...
        <div class="box-body">
            ...
            <form id="formulario" action="" method="post">
                <div class="titulo col-sm-12">
                    <input type="hidden" value="<?php echo $datosEncuesta[0][3] ?>" id="tlf" name="tlf">
                    <input type="hidden" value="<?php echo $datosEncuesta[0][0] ?>" id="id_encuesta" name="id_encuesta">
                    <input type="hidden" value="<?php echo $datosEncuesta[0][6] ?>" id="id_operadora" name="id_operadora">
                ...
                <div class="col-sm-12"  id='resultado1'></div>
          
                <div class="col-sm-12">&nbsp;</div>

                <div class='col-md-12'>

                    <button type="" id="registrar" class="btn btn-success">Registrar</button> 
            ...
            if (dataUser.cedula === '' ||
                ...
                $("#formulario").submit(function() {
                    ...
                    $.ajax({
                        ...
                        dataType: 'html',
                        data: $(this).serialize(),
                        url: "insertar_respuesta",
                        // mostramos un loader antes de enviar los datos
                        beforeSend: function() {
                            $("#resultado1").show();
                            $("#resultado1").html('<div><?php echo '<img width="2%" src="' . base_url() . 'application/recursos/imagenes/ajax-loader_1.gif">'; ?></div>');
                        },
                        //Despues de enviar los datos limpiamos los campos del formulario
                        success: function(respuesta) {


                            $("#resultado1").html("<div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert'>&times;</button><i class='icon fa fa-check'></i> Suceso..!Los Datos Fueron registrados Exitosamente</div>");
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#desactivar").click(function() {
            var dataUser = {
                "id_operadora": $("#id_operadora").val(),
                "tlf": $("#tlf").val()

            };
            $.ajax({
                url: "<?php echo base_url() . 'index.php/Formularios/desactivar_numero'; ?>",
                type: "POST",
                data: dataUser,
                beforeSend: function() {
                    $("#resultado2").show();
                ...
                success: function(respuesta) {
                    ...
                    $("#resultado2").html("<div class='alert alert-warning alert-dismissable'><button type='button' class='close' data-dismiss='alert'>&times;</button><i class='icon fa fa-check'></i> Suceso..!El numero Fue Desactivado Exitosamente</div>");
            ...
            setInterval(function() {
                window.location.href = $("#url_respuesta").val();
            }, 1500); //Lo temporizamos a 3 segundos para mostrar el mensaje al usuario
        });
    });
</script>
<script type="text/javascript">
    $(document).ready(function() {
        $("#eliminar").click(function() {
            ...
            $.ajax({
                url: "<?php echo base_url() . 'index.php/Formularios/eliminar_numero'; ?>",
                type: "POST",
                data: dataUser,
                beforeSend: function() {
                    $("#resultado2").show();
                ...
                success: function(respuesta) {
                    // Enviamos un mensaje de exito al insertar los datos
                    $("#resultado2").html("<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert'>&times;</button><i class='icon fa fa-check'></i> Suceso..!El numero Fue Eliminado Exitosamente</div>");
